...
class TinEye(object):
    ...
    def search(self, url):
        ...
        values = {
            'url' : 'http://www.japantimes.co.jp/wp-content/uploads/2017/03/n-lion-a-20170324.jpg',
            'submit' : 'Search'
        }
...
if __name__ == '__main__':
    tineye = TinEyePhoto('test', 'http://www.japantimes.co.jp/wp-content/uploads/2017/03/n-lion-a-20170324.jpg')
    tineye.search(tineye.image_url)
